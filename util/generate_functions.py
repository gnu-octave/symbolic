...
# These functions need numerical implementations from mpmath.  Don't list
# things here that have native implementations in Octave!
numerical_list = \
"""
coshint|chi
sinhint|shi
...
%! B = double ({NAME} (y));
%! assert (A, B, -4*eps);
""".format(NAME=f, SPNAME=d['mpmathname'], NUMRESULT=numresult)
